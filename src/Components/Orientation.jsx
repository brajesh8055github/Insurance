...
// const Orientation = () => {
//   const textItems = [
//     "Seamless and Secure Insurance Services.",
//     "Instant Policy Access Anytime, Anywhere.",
//     "Fast & Hassle-Free Claim Settlement."
//   ];
...
//         {/* Sliding Text */}
//         <p className="text-lg text-orange-500 font-semibold mt-4 min-h-[40px] transition-opacity duration-500">
//           {textItems[index]}
//         </p>
//       </div>
//     </div>
