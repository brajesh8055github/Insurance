...
//   return (
//     <div className="bg-gray-100 py-10 px-4 lg:px-20">
...
//                   />
//                   <span className={`${index === 0 ? "text-orange-500 font-semibold" : ""}`}>
//                     {type}
//                   </span>
//                 </label>
//               ))}
...
//         {/* Right Section (Image Slider, Takes Less Space) */}
//         <div className="lg:w-2/5 w-full max-w-md mx-auto overflow-hidden relative">
//           <img
  ...
  return (
    ...
    <div className="bg-gray-100 py-10 px-4">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[3fr_2fr] gap-10 items-center">
        ...
        {/* Right Content - Takes Less Space */}
